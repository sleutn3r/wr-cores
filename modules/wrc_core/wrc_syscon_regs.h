/*
  ...
  * Created        : Tue Oct 18 19:11:48 2016
  * Standard       : ANSI C
...
/* definitions for register: Trigger control register */

/* definitions for field: Enable generation in reg: Trigger control register */
#define SYSC_TCR_EN                           WBGEN2_GEN_MASK(0, 1)

/* definitions for field: Reset counters in reg: Trigger control register */
#define SYSC_TCR_RST                          WBGEN2_GEN_MASK(1, 1)

/* definitions for register: Trigger period */

/* definitions for register: TX trigger counter L */

/* definitions for register: TX trigger counter H */

/* definitions for register: RX trigger counter L */

/* definitions for register: RX trigger counter H */
...
/* [0x18]: REG Trigger control register */
#define SYSC_REG_TCR 0x00000018
/* [0x1c]: REG Trigger period */
#define SYSC_REG_TP 0x0000001c
/* [0x20]: REG TX trigger counter L */
#define SYSC_REG_TXTL 0x00000020
/* [0x24]: REG TX trigger counter H */
#define SYSC_REG_TXTH 0x00000024
/* [0x28]: REG RX trigger counter L */
#define SYSC_REG_RXTL 0x00000028
/* [0x2c]: REG RX trigger counter H */
#define SYSC_REG_RXTH 0x0000002c
#endif
