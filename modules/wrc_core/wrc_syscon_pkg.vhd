...
package sysc_wbgen2_pkg is
  ...
  type t_sysc_in_registers is record
    ...
    txtl_i                                   : std_logic_vector(31 downto 0);
    txth_i                                   : std_logic_vector(31 downto 0);
    rxtl_i                                   : std_logic_vector(31 downto 0);
    rxth_i                                   : std_logic_vector(31 downto 0);
    end record;
  ...
  constant c_sysc_in_registers_init_value: t_sysc_in_registers := (
    ...
    type t_sysc_out_registers is record
      ...
      tcr_en_o                                 : std_logic;
      tcr_rst_o                                : std_logic;
      tp_o                                     : std_logic_vector(31 downto 0);
      end record;
...
tmp.txtl_i := f_x_to_zero(left.txtl_i) or f_x_to_zero(right.txtl_i);
tmp.txth_i := f_x_to_zero(left.txth_i) or f_x_to_zero(right.txth_i);
tmp.rxtl_i := f_x_to_zero(left.rxtl_i) or f_x_to_zero(right.rxtl_i);
tmp.rxth_i := f_x_to_zero(left.rxth_i) or f_x_to_zero(right.rxth_i);
return tmp;
end function;
end package body;
