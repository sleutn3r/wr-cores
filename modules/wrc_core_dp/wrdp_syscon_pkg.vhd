...
package syscdp_wbgen2_pkg is
  
  
  -- Input registers (user design -> WB slave)
  
  type t_syscdp_in_registers is record
    gpsr_fmc_scl_i                           : std_logic;
    gpsr_fmc_sda_i                           : std_logic;
    gpsr_sfp0_det_i                          : std_logic;
    gpsr_sfp0_scl_i                          : std_logic;
    gpsr_sfp0_sda_i                          : std_logic;
  ...
  constant c_syscdp_in_registers_init_value: t_syscdp_in_registers := (
    gpsr_fmc_scl_i => '0',
    gpsr_fmc_sda_i => '0',
    gpsr_sfp0_det_i => '0',
    gpsr_sfp0_scl_i => '0',
    ...
    type t_syscdp_out_registers is record
      ...
      gpsr_sfp0_scl_o                          : std_logic;
      gpsr_sfp0_scl_load_o                     : std_logic;
      gpsr_sfp0_sda_o                          : std_logic;
      gpsr_sfp0_sda_load_o                     : std_logic;
      ...
      gpcr_sfp0_scl_o                          : std_logic;
      gpcr_sfp0_sda_o                          : std_logic;
    ...
    constant c_syscdp_out_registers_init_value: t_syscdp_out_registers := (
      ...
      gpsr_net_rst_o => '0',
      gpsr_sfp0_scl_o => '0',
      gpsr_sfp0_scl_load_o => '0',
      gpsr_sfp0_sda_o => '0',
      gpsr_sfp0_sda_load_o => '0',
      gpsr_spi_sclk_o => '0',
    ...
    function "or" (left, right: t_syscdp_in_registers) return t_syscdp_in_registers;
    function f_x_to_zero (x:std_logic) return std_logic;
    function f_x_to_zero (x:std_logic_vector) return std_logic_vector;
end package;

package body syscdp_wbgen2_pkg is
...
function "or" (left, right: t_syscdp_in_registers) return t_syscdp_in_registers is
variable tmp: t_syscdp_in_registers;
begin
...
tmp.gpsr_sfp0_det_i := f_x_to_zero(left.gpsr_sfp0_det_i) or f_x_to_zero(right.gpsr_sfp0_det_i);
tmp.gpsr_sfp0_scl_i := f_x_to_zero(left.gpsr_sfp0_scl_i) or f_x_to_zero(right.gpsr_sfp0_scl_i);
tmp.gpsr_sfp0_sda_i := f_x_to_zero(left.gpsr_sfp0_sda_i) or f_x_to_zero(right.gpsr_sfp0_sda_i);
