...
package spll_wbgen2_pkg is
  ...
  type t_spll_in_registers is record
    ...
    freq_csr_freq_i                          : std_logic_vector(25 downto 0);
    freq_csr_valid_i                         : std_logic;
    end record;
  ...
  constant c_spll_in_registers_init_value: t_spll_in_registers := (
    ...
    type t_spll_out_registers is record
      ...
      freq_csr_valid_o                         : std_logic;
      freq_csr_valid_load_o                    : std_logic;
      freq_csr_chan_sel_o                      : std_logic_vector(4 downto 0);
      end record;
    ...
    constant c_spll_out_registers_init_value: t_spll_out_registers := (
      ...
      aux_cr_gate_wr_o => '0',
      freq_csr_valid_o => '0',
      freq_csr_valid_load_o => '0',
      freq_csr_chan_sel_o => (others => '0')
      );
...
tmp.freq_csr_freq_i := f_x_to_zero(left.freq_csr_freq_i) or f_x_to_zero(right.freq_csr_freq_i);
tmp.freq_csr_valid_i := f_x_to_zero(left.freq_csr_valid_i) or f_x_to_zero(right.freq_csr_valid_i);
return tmp;
end function;
end package body;
